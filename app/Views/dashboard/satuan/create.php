            ...
            <div class="card-body">
                <form action="<?= base_url('satuan/store') ?>" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= validation_errors('sat_nama') ? 'is-invalid' : '' ?>" name="sat_nama" id="sat_nama" autocomplete="off" placeholder="Isikan Nama Satuan" autofocus>
