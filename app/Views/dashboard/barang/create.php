            ...
            <div class="card-body">
                <form action="<?= base_url('barang/store') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control <?= validation_errors('brg_kode') ? 'is-invalid' : '' ?>" name="brg_kode" id="brg_kode" autocomplete="off" placeholder="Isikan Kode Barang" value="<?= $kodeBarang ?>" readonly>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control <?= validation_errors('brg_nama') ? 'is-invalid' : '' ?>" name="brg_nama" id="brg_nama" autocomplete="off" placeholder="Isikan Nama Barang">
                            <div class="form-text text-danger">
                        ...
                        <div class="col-sm-4">
                            <select name="brg_sat_id" id="brg_sat_id" class="custom-select <?= validation_errors('brg_sat_id') ? 'is-invalid' : '' ?>">
                                ...
                                <?php foreach ($dataSatuan as $row) : ?>
                                    <option value="<?= $row['sat_id'] ?>"><?= $row['sat_nama'] ?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="form-text text-danger">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control <?= validation_errors('brg_harga') ? 'is-invalid' : '' ?>" name="brg_harga" id="brg_harga" autocomplete="off" placeholder="Isikan Harga">
                            <div class="form-text text-danger">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control <?= validation_errors('brg_stok') ? 'is-invalid' : '' ?>" name="brg_stok" id="brg_stok" autocomplete="off" placeholder="Isikan Stok">
                            <div class="form-text text-danger">
                    ...
                    <div class="form-group row">
                        <label for="brg_gambar" class="col-sm-3 col-form-label">Upload Gambar (<i>Jika Ada...</i>)</label>
                        <div class="col-sm-9">
